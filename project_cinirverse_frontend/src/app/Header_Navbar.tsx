...
const Navbar = () => {
  ...
  return (
    <header className='flex justify-between bg-black sticky top-0  '>
      ...
      <div className='flex'>
        {loggedIn? (<button className='text-white flex '><span className=' mt-3'>Profile</span><svg className='hover:fill-red-600 ' width="50px" height="50px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
